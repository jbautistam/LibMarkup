...
public class MLItemsBaseCollection<TypeData> : List<TypeData> where TypeData : MLItemBase, new()
{
	...
	///		Añade un nodo a la colección
	/// </summary>
	public TypeData Add(string name, DateOnly? value) => Add(null, name, value);

	/// <summary>
	///		Añade un nodo a la colección
	/// </summary>
	public TypeData Add(string prefix, string name, DateOnly? value) => Add(prefix, name, MLItemBase.Format(value));

	/// <summary>
	///		Añade un nodo a la colección
	/// </summary>
	public TypeData Add(string name, TimeOnly? value) => Add(null, name, value);

	/// <summary>
	///		Añade un nodo a la colección
	/// </summary>
	public TypeData Add(string prefix, string name, TimeOnly? value) => Add(prefix, name, MLItemBase.Format(value));

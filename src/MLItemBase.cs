...
{ 
	...
	/// <summary>
	///		Formatea un valor <see cref="bool"/>
	/// </summary>
	...
	/// <summary>
	///		Formatea un valor <see cref="double"/>
	/// </summary>
	...
	/// <summary>
	///		Formatea un valor de tipo <see cref="DateTime"/>
	/// </summary>
	...
	/// <summary>
	///		Formatea un valor de tipo <see cref="DateOnly"/>
	/// </summary>
	internal static string Format(DateOnly? value)
	{
		if (value is null)
			...
			return $"{value:yyy-MM-dd}";
	}

	/// <summary>
	///		Formatea un valor de tipo <see cref="TimeOnly"/>
	/// </summary>
